...
$(document.body).append(
	createElement('div', {class: "someclass"},
		[
			...
			createElement('span', {class: "paragraph"},
				[
					'Refer to Capital\'s Guide for Writing Research Papers and, especially, the ,/* <-- here is the error, a missing single quote */
					facultyType,
